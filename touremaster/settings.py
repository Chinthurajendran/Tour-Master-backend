"""
Django settings for touremaster project.
...
SECRET_KEY = 'django-insecure-ih5ipsxiclrsi^huv!y)8$n!1%b=nd!zjog1!y+o(fke=%rx$k'
...
WSGI_APPLICATION = 'touremaster.wsgi.application'
...
EMAIL_FROM_NAME=config("MAIL_FROM_NAME")
